...
abstract class $AuthResponseModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({User user, bool isAuthorized, String token});
...
class _$AuthResponseModelImpl implements _AuthResponseModel {
  _$AuthResponseModelImpl(
      {required this.user, required this.isAuthorized, required this.token});
  ...
  @override
  String toString() {
    return 'AuthResponseModel(user: $user, isAuthorized: $isAuthorized, token: $token)';
  }
...
abstract class _AuthResponseModel implements AuthResponseModel {
  factory _AuthResponseModel(
      ...
      required String token}) = _$AuthResponseModelImpl;
